...
setsize.addEventListener("click", function() {
    ...
    // Reset state and grid on re-submit
    ord = [];
    ord2 = [];
    cur = [];
    nb = [];
...
function animate(index) {
    ...
    let parentc = ord[index][3];

    let cid = cidc[0] * m + cidc[1];
    let parent = parentc[0] * m + parentc[1];
    ...
    if (direction == 1) { borbo = "0px solid black"; }
    if (direction == 2) { borto = "0px solid black"; }
    if (direction == 3) { borri = "0px solid black"; }
    if (direction == 4) { borlef = "0px solid black"; }

    if (direction == 1) { Pborto = "0px solid black"; }
    if (direction == 2) { Pborbo = "0px solid black"; }
    if (direction == 3) { Pborlef = "0px solid black"; }
    if (direction == 4) { Pborri = "0px solid black"; }
